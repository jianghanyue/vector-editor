...
export declare type NodeChange = CreateChange | DeleteChange | PropertyChange
...
export declare type VectorPaths = ReadonlyArray<VectorPath>
...
export declare type HandleMirroring = 'NONE' | 'ANGLE' | 'ANGLE_AND_LENGTH'
